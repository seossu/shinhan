...
const GIFT_CATEGORIES = {
  culture: {
    ...
    gifts: [
      ...
      { name: "인스파이어 초대권", desc: "인스파이어 리조트 특별 초대" },
    ],
  },
  activity: {
    id: "activity",
  ...
  physical: {
    ...
    gifts: [
      ...
      { name: "사옥 전광판 광고", desc: "사옥 전광판에 우리 팀 광고!" },
    ],
  },
  growth: {
    id: "growth",
    ...
    color: "#2196F3",
    gifts: [
      { name: "특별 팀 프로필 뱃지 제공", desc: "우리 팀만의 특별한 뱃지" },
      { name: "투자 플러스 무료 체험권", desc: "프리미엄 투자 분석 서비스" },
      { name: "팀 노션 패키지 제공", desc: "협업을 위한 노션 템플릿" },
      { name: "리스크 분석 보고서 1회 제공", desc: "전문가의 리스크 분석" },
      { name: "팀 포트폴리오 진단권", desc: "전문가의 포트폴리오 진단" },
      { name: "멘토링 지원", desc: "업계 전문가와의 1:1 멘토링" },
